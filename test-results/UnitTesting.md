(1)---Test error responses: Test that checks for a 404 Not Found error---
...
(3)---Testing a POST request: In this test just checking the response status, indicating that the new user was created successfully---
...
(4)---Testing a delete request: In this test we were checking that the user was successfully deleted---
...
(5)---Testing a PUT resquest: Checking that the user was successfully updated---
